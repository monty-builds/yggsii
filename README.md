...
- first-pass reveal-ledger support in the workspace, with project-level reveal records, scene and character linking, local persistence, and import/export round-tripping
