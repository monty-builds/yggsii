...
- workspace search across scenes, characters, and locations, grouped by entity type, with direct jump back into scene or character context and timeline-filter handoff for location results
