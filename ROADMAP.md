...
A first ranking pass is now in place too, and manuscript, location, and character inspection now link directly back into scene editing.

The next ergonomic gain is probably richer relevance rules than simple text scoring, plus more cross-links outward from scenes into the other views.
